(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('@angular/forms'),require('@ngx-formly/core'),require('@ngx-formly/core/select'),require('@ngx-formly/bootstrap/addons'),exports, require('rxjs/operators'), require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@ngx-formly/core'), require('@ngx-formly/core/select'), require('@ngx-formly/bootstrap/addons')) :
    typeof define === 'function' && define.amd ? define('@ngx-formly/bootstrap', ['@angular/core','@angular/common','@angular/forms','@ngx-formly/core','@ngx-formly/core/select','@ngx-formly/bootstrap/addons','exports', 'rxjs/operators', '@angular/core', '@angular/common', '@angular/forms', '@ngx-formly/core', '@ngx-formly/core/select', '@ngx-formly/bootstrap/addons'], factory) :
    (factory(global.ng.core,global.ng.common,global.ng.forms,global.ngxFormly.core,global.ngxFormly.core.select,global.ngxFormly.bootstrap.addons,(global['ngx-formly'] = global['ngx-formly'] || {}, global['ngx-formly'].bootstrap = {}),global.rxjs.operators,global.ng.core,global.ng.common,global.ng.forms,global.core$1,global.select,global['ngx-formly'].bootstrap.addons));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,ɵngcc5,exports,operators,core,common,forms,core$1,select,addons) { 
...
FormlyFieldSelect.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: FormlyFieldSelect, selectors: [["formly-field-select"]], viewQuery: function FormlyFieldSelect_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(forms.SelectControlValueAccessor, true);
    } if (rf & 2) {
        var _t;
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(FormlyFieldSelect, [{
        ...
        args: [{
            ...
            type: core.ViewChild,
            args: [forms.SelectControlValueAccessor]
        }] }); })();
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(FormlyBootstrapModule, { declarations: [FormlyFieldInput, FormlyFieldCheckbox, FormlyFieldRadio, FormlyFieldSelect, FormlyFieldTextArea, FormlyFieldMultiCheckbox, FormlyWrapperFormField], imports: [ɵngcc1.CommonModule, ɵngcc2.ReactiveFormsModule, ɵngcc4.FormlySelectModule, ɵngcc3.FormlyModule, ɵngcc5.FormlyBootstrapAddonsModule] }); })();
